...
from poser.test_utils.compat import skipIf
from poser.test_utils.testcases import POSERTestCase
from poser.test_utils.util.context_managers import TemporaryDirectory
...
ROOT_DIR = os.path.dirname(poser.__file__)
...
class DocsTestCase(POSERTestCase):
    """
